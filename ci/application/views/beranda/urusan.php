                ...
                <div class="content-side col-xl-9 col-lg-8 col-md-12 col-sm-12">
                    <div class="blog-single pr-lg-4">
                        <div class="inner-box">
                                    ...
                                    <h3 >Urusan Pemerintahan Daerah</h3>
                                    <ul class="post-info clearfix gb">
                                        <li> Upload tanggal : 15 Jan 2018</li>
                                     </ul>
                            <div class="lower-content">
                                ...
                                <div class="lower-box">
                                    ...
                                    <center>
                                        ...
                                        <img src="<?= base_url('assets'); ?>/images/logopemda2.png" style="width:50%; align-items: center;" alt="">
                                    </center>
