...
class Hasil_kerjasama extends CI_Controller 
{
 	...
 	public function index()
	{
		...
		$config['base_url']=base_url('hasil_kerjasama/index');
		$config['total_rows']=$this->m_allberita->hitunghasil();
		$config['per_page']=6;
		...
		$data['berita']=$this->m_allberita->show_allhasil($config['per_page'], $data['start']);
		...
		$data['tittle']='hasil';
		$data['total_berita']=$this->m_allberita->hitunghasil();
		$this->load->view('header/head');
		$this->load->view('header/menu', $data);
		$this->load->view('hasil_kerjasama/hasil_kerjasama');
...
// 		$data['recent']	= $this->Publikasi_model->getnewberita(3);
		...
		$this->load->view('header/head');
		$this->load->view('header/menu', $data);
		$this->load->view('hasil_kerjasama/isi');
