                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <section>
                            ...
                            <div class="col-sm-8">
                                ...
                                <b>Input No Tkksd</b> Max Length : 255.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="pd_pemrakasa[]" id="pd_pemrakasa" data-placeholder="Select OPD/PD Pemrakarsa" multiple >
                                    <option value=""></option>
                                    <?php foreach (db_get_all_data('tb_daftar_pd') as $row): ?>
                                    <option <?=  in_array($row->nama_pede, explode(',', $tb_tkksd->pd_pemrakasa)) ? 'selected' : ''; ?> value="<?= $row->nama_pede ?>"><?= $row->nama_pede; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
                        ...
                        <section>
                                                <div class="form-group ">
                            <label for="dokumen_tkksd" class="col-sm-2 control-label"> Lampiran Dokumen (Sebagai Arsip/ Tidak dipublikasikan)  
                            </label>
                            <div class="col-sm-8">
                                ...
                                <small class="info help-block">
                                <b>Extension file must</b> PDF,DOCX.</small>
                            </div>
                        </div>
