...
<section class="content-header">
    <h1>
        Gambar Slider        <small><?= cclang('new', ['Gambar Slider']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Gambar Slider']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_tb_slider', 
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tb_slider_gambar_slider_uuid" id="tb_slider_gambar_slider_uuid" type="hidden" value="<?= set_value('tb_slider_gambar_slider_uuid'); ?>">
                                <input class="data_file" name="tb_slider_gambar_slider_name" id="tb_slider_gambar_slider_name" type="hidden" value="<?= set_value('tb_slider_gambar_slider_name'); ?>">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/tb_slider/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id_gambar_slider = $('#tb_slider_gambar_slider_galery').find('li').attr('qq-file-id');
            ...
            $('.message').fadeIn();
            resetForm();
            if (typeof id_gambar_slider !== 'undefined') {
                    $('#tb_slider_gambar_slider_galery').fineUploader('deleteFile', id_gambar_slider);
                }
