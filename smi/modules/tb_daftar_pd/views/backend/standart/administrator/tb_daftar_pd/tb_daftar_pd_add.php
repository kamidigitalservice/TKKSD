...
<section class="content-header">
    <h1>
        Daftar Perangkat Daerah        <small><?= cclang('new', ['Daftar Perangkat Daerah']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Daftar Perangkat Daerah']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_pede" id="nama_pede" placeholder="Nama Perangkat Daerah" value="<?= set_value('nama_pede'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="singkatan_pede" id="singkatan_pede" placeholder="Singkatan OPD" value="<?= set_value('singkatan_pede'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <textarea id="deskripsi_pede" name="deskripsi_pede" rows="5" class="textarea form-control"><?= set_value('deskripsi_pede'); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="alamat_pede" name="alamat_pede" rows="5" class="textarea form-control"><?= set_value('alamat_pede'); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/tb_daftar_pd/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
