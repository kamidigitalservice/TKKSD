...
<section class="content-header">
    <h1>
        Kategori Publikasi        <small><?= cclang('new', ['Kategori Publikasi']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Kategori Publikasi']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_kat_pub" id="nama_kat_pub" placeholder="Nama Kategori" value="<?= set_value('nama_kat_pub'); ?>">
                            ...
                            <div class="col-sm-8">
                                <textarea id="deskripsi_kat_pub" name="deskripsi_kat_pub" rows="5" cols="80"><?= set_value('Deskripsi Kat Pub'); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/tb_kategori_publikasi/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
