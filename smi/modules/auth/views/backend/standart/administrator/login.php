...
<head>
  ...
  <title>Pintu Masuk | Administrator</title>
...
<body style="background:#b0b192"class="hold-transition login-page">
<div class="login-box">
  <div class="login-logo">
     <img width="120px"src="<?= theme_asset(); ?>img/ikon.png" style="margin-bottom:70px">
      <p style="font-size:24px"><b>Administrator</b></p>
     <p style="font-size:16px"><b>Ruang Kendali</b><br>Pemerintah Kabupaten Sukabumi</p>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body" style="background:#ffffff3b">
    <p class="login-box-msg"><b>Login </b>masuk !</p>
