...
<section class="content-header">
    <h1>
        Sosial Media        <small><?= cclang('new', ['Sosial Media']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Sosial Media']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_tb_sosmed', 
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_sosmed" id="nama_sosmed" placeholder="Nama Sosmed" value="<?= set_value('nama_sosmed'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="link_url" id="link_url" placeholder="Link URL" value="<?= set_value('link_url'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="tb_sosmed_logo_gambar_uuid" id="tb_sosmed_logo_gambar_uuid" type="hidden" value="<?= set_value('tb_sosmed_logo_gambar_uuid'); ?>">
                                <input class="data_file" name="tb_sosmed_logo_gambar_name" id="tb_sosmed_logo_gambar_name" type="hidden" value="<?= set_value('tb_sosmed_logo_gambar_name'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/tb_sosmed/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id_logo_gambar = $('#tb_sosmed_logo_gambar_galery').find('li').attr('qq-file-id');
            ...
            $('.message').fadeIn();
            resetForm();
            if (typeof id_logo_gambar !== 'undefined') {
                    $('#tb_sosmed_logo_gambar_galery').fineUploader('deleteFile', id_logo_gambar);
                }
