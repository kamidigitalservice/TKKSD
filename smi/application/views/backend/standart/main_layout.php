...
<head>
  ...
  <link rel="shortcut icon" href="<?= BASE_ASSET; ?>/img/ikon.png">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?= site_url('/'); ?>" class="logo" style="background-color:#bc9d06">
...
<script>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?=date('Y'); ?> <a href="#">Kabupaten Sukabumi</a>.</strong>
  </footer>
