...
<nav id="mainNav" style="background-color:#00000047 !important;border-color:rgba(34, 34, 34, 0.01)"class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    <a style="text-transform: capitalize;"class="page-scroll" href="<?= site_url('administrator/login'); ?>"><i class="fa fa-sign-in"></i> <?= cclang('login'); ?></a>
                </li>
                <?php else: ?>
                <li>
